...
public class LUISResponse {
    ...
    public LUISResponse(String query, LUISIntent topScoringIntent, List<LUISIntent> intents, List<LUISEntity> entities, List<LUISCompositeEntity> compositeEntities, LUISDialog dialog) {
        this.query = query;
